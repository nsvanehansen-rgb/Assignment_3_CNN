# PCAM DenseNet Classification Project
...
```bash
git clone [https://github.com/nsvanehansen-rgb/rnn-attention-assignment.git](https://github.com/nsvanehansen-rgb/rnn-attention-assignment.git)
cd rnn-attention-assignment
